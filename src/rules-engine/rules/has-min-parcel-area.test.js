...
describe('has-min-parcel-area', function () {
  test.each(passTestCases)(
    'should return true if the parcel area ($landParcelArea) is greater than or equal to the minimum ($minimumArea)',
    function ({ landParcelArea, minimumArea }) {
      const application = {
        areaAppliedFor: 1,
